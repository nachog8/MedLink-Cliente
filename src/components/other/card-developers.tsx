...
export default function CardDeveloper({
  ...
  return (
    <div className="relative">
      ...
      <Card className="relative z-10 flex h-full w-full max-w-md flex-col justify-between overflow-visible rounded-xl border-none bg-transparent p-5 shadow-transparent">
        ...
        <CardContent className="p-6 pt-20 text-center">
          <h2 className="text-lg font-bold text-gray-800 dark:text-white md:text-2xl">
            {name}
          </h2>
        ...
        <CardFooter className="flex justify-around space-x-4 rounded-b-xl bg-gray-50 p-6 dark:bg-gray-600">
